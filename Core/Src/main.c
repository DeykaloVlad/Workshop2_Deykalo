...
int main(void)
{
  ...
  HAL_TIM_PWM_Start(&htim4, TIM_CHANNEL_1); // Запуск ШІМ на каналі 1 таймера 4
    ...
    TIM4->CCR1 = 36537;  // Встановлення ширини імпульсу (duty cycle) для каналу 1
    TIM4->CCR2 = 30768;  // Встановлення ширини імпульсу для каналу 2
    TIM4->CCR3 = 34614;  // Встановлення ширини імпульсу для каналу 3
    TIM4->CCR4 = 32050;  // Встановлення ширини імпульсу для каналу 4
  /* USER CODE END 2 */
